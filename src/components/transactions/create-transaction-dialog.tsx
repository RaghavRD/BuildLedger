...
export function CreateTransactionDialog({ projectId }: { projectId: string }) {
    ...
    return (
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button className="w-full sm:w-auto text-xs sm:text-sm h-9 sm:h-8">
                    <Plus className="mr-1 sm:mr-2 h-3 w-3 sm:h-4 sm:w-4" /> Add Transaction
                </Button>
            </DialogTrigger>
            <DialogContent className="sm:max-w-[425px]">
                <form onSubmit={handleSubmit}>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Record a debit (expense) or credit (income/refund) for this project.
                        </DialogDescription>
                    </DialogHeader>
                    <div className="grid gap-6 py-4">
                        ...
                        <div className="flex flex-col sm:grid sm:grid-cols-4 sm:items-center gap-2 sm:gap-4">
                            ...
                            <Select name="category" required defaultValue="MATERIALS">
                                <SelectTrigger className="sm:col-span-3 h-11 sm:h-9">
                        ...
                        <div className="flex flex-col sm:grid sm:grid-cols-4 sm:items-center gap-2 sm:gap-4">
                            ...
                            <Input
                                ...
                                className="sm:col-span-3 cursor-pointer h-11 sm:h-9 px-2 py-2"
                            />
                        </div>
